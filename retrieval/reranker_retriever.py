...
class RerankerRetriever:
    ...
    def __init__(
        ...
        self.top_k=base_retriever.top_k
        self.id_to_metadata = base_retriever.id_to_metadata
        
        self.embedding_dir = getattr(base_retriever, 'embedding_dir', None)
        self.chunking_Type = getattr(base_retriever, 'chunking_type', None)
